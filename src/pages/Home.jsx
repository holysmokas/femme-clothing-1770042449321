  ...
  return (
    <div>
      ...
      <section 
        ...
        style={{ background: 'linear-gradient(135deg, #1e2a67 0%, #12193e 100%)' }}
      >
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-6">Femme Clothing</h1>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">Join thousands of satisfied customers who trust Femme Clothing for their fashion needs.</p>
          <Link 
            to="/shop" 
            className="text-white px-8 py-3 rounded-lg font-semibold hover:opacity-90 transition inline-block"
            style={{ backgroundColor: '#1e2a67' }}
